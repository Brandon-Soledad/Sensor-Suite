...
/**
 * @author Rodrigo, Maritaria, Joseph Yun
 */
public final class GraphView extends JPanel {
    ...
    public GraphView(String xLabel, String yLabel) {
    ...
    protected void paintComponent(Graphics graphics) {
        ...
        for (int i = 0; i < numberYDivisions + 1; i++) {
            ...
            if (length > 0) {
                ...
                final String yLabel = tickValue + this.yLabel;
        ...
        if (length > 1) {
            for (int i = 0; i < length; i++) {
                ...
                if ((i % ((int) ((length / 20.0)) + 1)) == 0) {
                    ...
                    g.setColor(Color.BLACK);
                    final String xLabel = i + this.xLabel;
